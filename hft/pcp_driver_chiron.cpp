...
struct pcp_driver_chiron_private
{
    pcp_driver_chiron_private(void)
        : dpips_minmax_(0),
          summand_(0.0),
          multiplier_(0.0),
          scale_factor_(0.0),
...
DECLARE_PCP_DRIVER(pcp_driver_chiron, pcp_driver_chiron_private, "chiron")

position_control::control pcp_driver_chiron::get_position_control_status(int cur_level_dpips)
{
    if (! configured_)
    {
        throw position_control_driver_exception("PCP driver „chiron” not configured");
    }
    ...
    {
        throw position_control_driver_exception("PCP driver „chiron”: Illegal position type");
    }

    return control::HOLD;
}

void pcp_driver_chiron::configure_from_json(cJSON *json)
{
    //
    ...
    {
        throw position_control_driver_exception("PCP driver „chiron”: Unspecified [summand] field");
    }
    ...
    {
        throw position_control_driver_exception("PCP driver „chiron”: Unspecified [multiplier] field");
    }
    ...
    {
        throw position_control_driver_exception("PCP driver „chiron”: Unspecified [scale_factor] field");
    }
...
void pcp_driver_chiron::reset_driver(void)
{
    dpips_minmax_ = 0;
}

void pcp_driver_chiron::setup_driver(void)
{
