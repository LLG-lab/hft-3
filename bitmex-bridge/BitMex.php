...
class BitMex {
  ...
  public function __construct($apiKey = '', $apiSecret = '', $trade_mode = '') {
  ...
  public function getCandles($timeFrame,$count,$endTime=null) {
    ...
    foreach($return as $item) {
      ...
      $candles[$time] = array(
        'timestamp' => date('d.m.Y H:i:s',$time), // Local time human-readable time stamp
        'time' => $time,
        'open' => $item['open'],
        'high' => $item['high'],
        'close' => $item['close'],
