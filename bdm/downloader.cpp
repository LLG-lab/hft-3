...
const char *const downloader::user_agent_fmt_ = "BitMex Data Manager client for Linux, version %d.%d";
    ...
    : curl_ctx_(NULL)
{
    ...
    if (!downloader::curl_global_initialized_)
    {
        ...
        std::string err_msg = "CURL globals uninitialized";
    ...
    sprintf(user_agent_name, downloader::user_agent_fmt_,
                BDM_VERSION_MAJOR, BDM_VERSION_MINOR);
